 ...
 */
final class Version20231013090729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_collection (id INT NOT NULL, collector_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5B2AA3DE670BAFFE ON user_collection (collector_id)');
        ...
        $this->addSql('ALTER TABLE user_collection ADD CONSTRAINT FK_5B2AA3DE670BAFFE FOREIGN KEY (collector_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_collection DROP CONSTRAINT FK_5B2AA3DE670BAFFE');
